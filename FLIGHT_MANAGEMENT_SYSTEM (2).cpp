...
void login()
{
	...
	cout << "\t\t\t\t\t@@|                                                                                       |@@\n";
	cout << "\t\t\t\t\t@@|                                                                                       |@@\n";
	cout << "\t\t\t\t\t@@|                                            DEVELOPED by SATYAM PATEL                  |@@\n";
	cout << "\t\t\t\t\t@@|_______________________________________________________________________________________|@@\n";
	cout << "\t\t\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n\t\t\t\t\t";
...
void schedule()
{
	...
	cout << "\t\t\t\t\t\tNumber count        Flight Name        From            To            Seats Left" << endl
		 << endl;
	cout << "\t\t\t\t\t\t<1>                 ind001              Delhi          Kolkata"
		 << "\t\t" << 40 - ind1 << endl
		 << endl;
	cout << "\t\t\t\t\t\t<2>                 ind001              Kolkata        Delhi"
		 << "\t\t" << 40 - ind1 << endl
		 << endl;
	cout << "\t\t\t\t\t\t<3>                 ind002              Mumbai         Delhi"
		 << "\t\t" << 60 - ind2 << endl
		 << endl;
	cout << "\t\t\t\t\t\t<4>                 ind003              Kolkata        Mumbai"
		 << "\t\t" << 120 - ind3 << endl
		 << endl;
	cout << "\t\t\t\t\t\t-------------------------------------------------------------------------------" << endl
		 << endl;
...
{
public:
	string id, name, age, gender, email, address, contact, depar, desti, f_name, seat_type, passport;
};
...
above:
	...
	cout << "\t\t\t\t\t\t\t\tNumber     Flight Name        Departure       Destination" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<1>        ind001              Delhi          Kolkata" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<2>        ind001              Kolkata         Delhi" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<3>        ind002              Mumbai          Delhi" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<4>        ind003              Kolkata         Mumbai" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t----------------------------------------------------------" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\tPress any key to continue...";
	...
	if (res == "1")
	{
		m[memberid].depar = "Delhi";
		m[memberid].desti = "Kolkata";
		m[memberid].f_name = "ind001";
	}
...
above1:
	...
	cout << "\t\t\t\t\t\t\t\tNumber     Seat Type        Price" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<1>        Simple Seat        Rs.3000 " << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<2>        Window side        Rs.3500 " << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t----------------------------------" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\tPress any key to continue...";
...
void Member ::alldata()
{
	...
	else
	{
		...
		{
			cout << "\t" << m[i].id << "\t\t" << m[i].name << "\t\t" << m[i].email << m[i].age << "\t\t" << m[i].gender << "\t\t" << m[i].contact << "\t" << m[i].f_name << "\t\t" << m[i].depar << "\t\t\t" << m[i].desti << endl
				 << endl;
		}
		cout << "\t\t\t\t\t\t--------------------------------------------------------------------------------" << endl
			 << endl;
